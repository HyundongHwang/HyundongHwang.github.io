...
- [`vscode + github.io + jekyll` 의 장점](#vscode--githubio--jekyll-의-장점)
    ...
    - [개발자 스웩](#개발자-스웩)
- [`vscode + github.io + jekyll` 의 단점이라기 보단 주의사항](#vscode--githubio--jekyll-의-단점이라기-보단-주의사항)
    - [github markdown 과 약간 다른 markdown 렌더러](#github-markdown-과-약간-다른-markdown-렌더러)
...
# `vscode + github.io + jekyll` 의 단점이라기 보단 주의사항
## github markdown 과 약간 다른 markdown 렌더러
- markdown에서 표를 만들때 셀에 back tick 이 포함되면 꼭 주위를 back tick 으로 둘러 쌓아야 한다.

```markdown
| c0 | c1 |
|---|---|
| hello | this is ` back tick  |
```
